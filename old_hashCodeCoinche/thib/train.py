...
def write_output(sol_dict, file_path="../output/instance.txt"):
    with open(path+os.sep+filename, 'w') as file_writer:
...
if __name__ == '__main__':
    read_input("./input/b.txt")
    read_input("./input/a.txt")
    read_input("./input/c.txt")
    read_input("./input/d.txt")
    read_input("./input/e.txt")
    read_input("./input/f.txt")
